...
public class RequestHeaderServlet extends HttpServlet {
    ...
    private static void printStart(HttpServletRequest request) {
...
/*
        Enumeration<String> headerNames = request.getHeaderNames(); //getHeaderNames = HTTP에 있는 모든 헤더 정보를 다 출력함
...
*/
        ...
        //request.getHeader("host"); 원하는 값 하나만 꺼낼 수 있다.
